...
public class PayInfo {
	@Id // paymentid 대신에
	private String receiptId; // PG 사에서 생성한 주문 번호 //receiptId: rsp.imp_uid!!,
	...
	// ERROR, PAID(결제완료), FAILED, READY(대기중), CANCEL(판매취소), SHIPPING(배송중),
	// COMPLETED(배송완료), UNSETTLEMENT(미정산), SETTLEMENT(정산완료)
