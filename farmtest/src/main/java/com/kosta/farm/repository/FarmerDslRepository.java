...
public class FarmerDslRepository {
	...
	public List<Tuple> findOrdersQuotByFarmerIdAndPaging(Long farmerId, PageRequest pageRequest) {
		...
		return jpaQueryFactory.select(pay.receiptId, quot.quotationProduct,
				quot.quotationQuantity, quot.quotationPrice, req.name, req.tel, req.address1, req.address2, req.address3)
				.from(pay)
	...
	// 정산 내역 리스트
	public List<Payment> findOrdersIdAndDeliveryAndProductAndByDeliveryState(Long farmerId, String sDate, String eDate,
